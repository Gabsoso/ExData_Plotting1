...
#plot.1
hist(power$Global_active_power, col = 'blue', main = 'Global Active Power', xlab = 'Global Active Power (kilowatts)')
...
plot(x=power$POSIX,y=power$Sub_metering_1, type='l', col = 'blue', ylab = 'Energy sub metering', xlab = '')
lines(x=power$POSIX,y=power$Sub_metering_2, col='purple')
lines(x=power$POSIX,y=power$Sub_metering_3, col='cyan')
